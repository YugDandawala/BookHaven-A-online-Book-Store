function displayMysterySellers() {
    const container = document.querySelector('#mysteryseller .row');
    if (!container) return;

    container.innerHTML = ""; // Clear any old content

    const MysteryBooks = allBooks.filter(b => b.id.startsWith("M")).slice(0, 8);
